...
alias: 2023/02/what-is-the-regulated-rate-option/
...
price, but is faster to jump up and much slower to come back down.

My personal option is that you're better to do with [our floating
rate]({filename}/pages/EL/floating-electricity.md), as over the longer term it
continues to be cheaper than the Regulated Rate Option.
