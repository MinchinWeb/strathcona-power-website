...
summary:  We offer [1 year]({filename}fixed-electricity-1-yr.md) and [5 year]({filename}fixed-electricity.md) fixed rates, and a [floating]({filename}floating-electricity.md) electricity rate. Right now, **our recommendation is our 5 year fixed electricity rate**.
copy_date: 2023-24
